...
export default function Paradisedetails() {
  ...
  const theaters: Theater[] = [
    {
      name: "INOX Laila Mall -Vijayawada",
      distance: "9.2 km",
      shows: [{ time: "10:40 AM" }, { time: "12:20 PM" }, { time: "05:50 PM" }],
    },
    {
      name: "Capital: Cinema ",
      distance: "1.6 km",
      shows: [
        { time: "10:45 PM", format: "DOLBY 7.1" },
        { time: "01:30 PM", format: "DOLBY 7.1" },
        { time: "06:45 PM", format: "DOLBY 7.1" },
      ],
    },
  ];
  ...
  const handleBooking = (theater: string, time: string) => {
    ...
    if (theater === "INOX Laila Mall -Vijayawada" && time === "01:40 PM") {
      setShowModal(true);
    } else {
      confirmBooking();
    }
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-black p-3 pt-20 md:pt-24">
        ...
        <div className="ml-2 md:ml-4">
          <h1 className="text-xl md:text-2xl font-bold mb-1">Paradise</h1>
          <p className="text-gray-600 text-sm md:text-base mb-4">Movie runtime: 2h 45m</p>
        </div>
