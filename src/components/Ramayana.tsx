...
export default function Ramayana() {
  const [rating] = useState("9.1/10 (250K Votes)");
  ...
  const posterUrl =
    "https://i.pinimg.com/1200x/09/15/79/091579525fc32329483371c986c0de34.jpg"; // ✅ Replace with a Ramayana poster
      ...
      <div className="flex-grow flex items-center justify-center p-4 md:p-8 mt-16">
        ...
        >
            ...
            <div className="relative w-full max-w-[300px] h-[500px] rounded-xl overflow-hidden shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                <div className="text-white">
                  <h2 className="text-xl font-bold">Ramayana</h2>
                  <p className="text-sm">The Epic Story</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center md:w-3/5 p-6 md:p-8 space-y-6 bg-transparent">
            ...
            >
              {["2D", "Telugu", "Tamil", "Hindi", "Malayalam"].map(
                (lang, index) => (
                  <span
                    key={lang}
            ...
            >
              ...
              <p className="text-lg font-medium">Epic, Mythology, Family</p>
            </div>
            ...
            >
              <button
                onClick={handleBook}
                className="book-button bg-orange-600 text-white w-full py-4 rounded-xl text-lg font-bold uppercase tracking-wide hover:bg-orange-700 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 shadow-lg hover:shadow-xl relative overflow-hidden group"
              >
                <span className="relative z-10">Book tickets</span>
                <span className="absolute inset-0 bg-orange-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></span>
              </button>
            </div>
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Ramayana is the timeless tale of Lord Rama, who embarks on a
                journey to rescue his wife Sita from the demon king Ravana. With
                the help of Hanuman and an army of vanaras, Rama battles evil to
                restore dharma. A story of love, sacrifice, loyalty, and the
