...
export default function Merai() {
  const [rating] = useState("8.4/10 (120K Votes)");
  ...
  const posterUrl =
    "https://i.pinimg.com/736x/20/08/99/2008992ac772e0515b7009be92204624.jpg"; // ✅ Replace with Merai poster

  return (
    <div className="min-h-screen w-full bg-white text-black flex flex-col">
      {/* Navbar */}
      <nav className="w-full p-4 bg-transparent fixed top-0 left-0 z-50">
        <h1 className="text-2xl md:text-3xl text-black tracking-wide">Merai</h1>
      </nav>
      ...
      <div className="flex-grow flex items-center justify-center p-4 md:p-8 mt-16">
        ...
        >
            ...
            <div className="relative w-full max-w-[300px] h-[500px] rounded-xl overflow-hidden shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                <div className="text-white">
                  <h2 className="text-xl font-bold">Merai</h2>
                  <p className="text-sm">A Tale of Courage</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center md:w-3/5 p-6 md:p-8 space-y-6 bg-transparent">
            ...
            >
              {["2D", "Telugu", "Hindi", "English"].map((lang, index) => (
                <span
                  key={lang}
            ...
            >
              ...
              <p className="text-lg font-medium">Action, Drama, Thriller</p>
            </div>
            ...
            >
              <button
                onClick={handleBook}
                className="book-button bg-blue-600 text-white w-full py-4 rounded-xl text-lg font-bold uppercase tracking-wide hover:bg-blue-700 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 shadow-lg hover:shadow-xl relative overflow-hidden group"
              >
                <span className="relative z-10">Book tickets</span>
                <span className="absolute inset-0 bg-blue-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></span>
              </button>
            </div>
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Merai is the story of a fearless young hero who rises against
                injustice and stands tall in the face of adversity. With a mix
                of courage, loyalty, and determination, Merai embarks on a
                journey that tests his strength and his spirit, ultimately
                proving that one person’s resolve can change the fate of many.
              </p>
            </div>
          </div>
        </div>
