...
export default function Paradise() {
  const [rating] = useState("8.3/10 (150K Votes)");
  ...
  const posterUrl =
    "https://i.pinimg.com/1200x/f4/5c/1b/f45c1b5b4e46cc8e973424faa990289f.jpg"; // 👉 replace with Paradise poster
        ...
        >
            ...
            <div className="relative w-full max-w-[300px] h-[500px] rounded-xl overflow-hidden shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                <div className="text-white">
                  ...
                  <p className="text-sm">A Journey to Heaven</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center md:w-3/5 p-6 md:p-8 space-y-6 bg-transparent">
            ...
            <div className="flex items-center flex-wrap gap-3">
              ...
              <button
                onClick={handleRate}
                className="border border-gray-300 px-4 py-2 rounded-lg font-semibold hover:bg-black hover:text-white transition-all duration-300 shadow-sm"
              >
                Rate now
              </button>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              {["2D", "English", "Hindi", "Tamil"].map((lang) => (
                <span
                  key={lang}
                  className="border border-gray-300 px-4 py-1.5 rounded-full font-semibold text-sm hover:bg-black hover:text-white transition-all duration-300 shadow-sm"
                >
                  {lang}
                </span>
              ))}
            ...
            <div>
              ...
              <p className="text-lg font-medium">Drama, Fantasy</p>
            </div>
            ...
            <div className="pt-4">
              <button
                onClick={handleBook}
                className="book-button bg-green-600 text-white w-full py-4 rounded-xl text-lg font-bold uppercase tracking-wide hover:bg-green-700 transition-all duration-300 shadow-lg"
              >
                Book tickets
              </button>
            </div>
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Paradise follows a group of travelers who embark on a mystical
                journey to discover a hidden land beyond reality. As they cross
                mountains, oceans, and enchanted forests, they encounter trials
                that test their courage, friendship, and hope. This tale of love
                and destiny asks one question: what does true paradise really
                mean?
              </p>
            </div>
          </div>
