...
export default function Paradise() {
  ...
  const posterUrl =
    "https://i.pinimg.com/1200x/f4/5c/1b/f45c1b5b4e46cc8e973424faa990289f.jpg";
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4 text-black w-64">
            <h1 className="text-3xl md:text-4xl font-bold">Paradise</h1>
            ...
            <div className="flex flex-col gap-1 text-gray-800 text-xs md:text-sm">
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4" /> <span>2h 49m</span>
              </div>
              <div className="flex items-center gap-2">
                <AlertCircle className="w-4 h-4" /> <span>B</span>
              </div>
              <div className="flex items-center gap-2">
