        ...
        >
          ...
          <div className="flex justify-center items-start md:w-2/5 p-6 md:p-8">
            <div className="relative w-full max-w-[300px] h-[500px] rounded-xl overflow-hidden shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
              <img
                src={posterUrl}
                alt="Narasimha Poster"
                className="w-full h-full object-cover rounded-xl"
                onLoad={() => setIsLoading(false)}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                <div className="text-white">
                  <h2 className="text-xl font-bold">Narasimha</h2>
                  <p className="text-sm">The divine protector</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center md:w-3/5 p-6 md:p-8 space-y-6 bg-transparent">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Narasimha is one of the fiercest avatars of Lord Vishnu, 
                who appears in the form of half-lion and half-man to 
                protect his devotee Prahlada and destroy the demon king Hiranyakashipu. 
                The story represents the triumph of good over evil, 
                showcasing divine power, justice, and faith.
              </p>
            </div>
          </div>
        </div>
